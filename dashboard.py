...
if st.session_state.page == "sales":
    ...
    if "Bobby Aquatic 1" in branch_selection:
        ...
        daily_profit_1, fitted_values_1, test_1, hw_forecast_future_1 = forecast_profit_1(penjualan_data_1)
    ...
    if "Bobby Aquatic 2" in branch_selection:
        ...
        daily_profit_2, fitted_values_2, test_2, hw_forecast_future_2 = forecast_profit_2(penjualan_data_2)
    ...
    if "Bobby Aquatic 1" in branch_selection and "Bobby Aquatic 2" in branch_selection:
        ...
        daily_profit_combined, fitted_values_combined, test_combined, hw_forecast_future_combined = forecast_profit_1(combined_penjualan_data)

    # Show the forecast dashboard based on branch selection
    if "Bobby Aquatic 1" in branch_selection and "Bobby Aquatic 2" in branch_selection:
        show_dashboard(
            daily_profit_1, fitted_values_1, test_1, hw_forecast_future_1, 
