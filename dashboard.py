...
if st.session_state.page == "sales":
    ...
    with tab1:
        ...
        penjualan_data_1 = load_all_excel_files(folder_path_1, sheet_name_1)
        ...
        daily_profit_1, hw_forecast_future_1 = forecast_profit(filtered_penjualan_data_1)
    ...
    with tab2:
        ...
        penjualan_data_2 = load_all_excel_files(folder_path_2, sheet_name_2)
        ...
        # Forecast and display dashboard
        daily_profit_2, hw_forecast_future_2 = forecast_profit(filtered_penjualan_data_2)
    ...
    with tab1:
        ...
        folder_path_1 = "./data/Bobby Aquatic 1"
        sheet_name_1 = 'Penjualan'
        cluster_data_1 = load_all_excel_files(folder_path_1, sheet_name_1)
        ...
        # Display clustering result for Bobby Aquatic 1 (assumed to be done elsewhere)
        st.write("Hasil kluster produk Bobby Aquatic 1")
    ...
    with tab2:
        ...
        folder_path_2 = "./data/Bobby Aquatic 2"
        sheet_name_2 = 'Penjualan'
        cluster_data_2 = load_all_excel_files(folder_path_2, sheet_name_2)
        ...
        # Display clustering result for Bobby Aquatic 2 (assumed to be done elsewhere)
        st.write("Hasil kluster produk Bobby Aquatic 2")
