            ...
            for cabang in filtered_data['Cabang'].unique():
                ...
                if cabang == 'Cabang 1' and not filtered_fitted_values_1.empty:
                    ...
                    if not filtered_test_1.empty and not filtered_test_forecast_1.empty:
                        ...
                        fig.add_trace(go.Scatter(x=combined_test_data_1.index, y=combined_test_data_1, mode='lines', name='Prediksi Data Test Cabang 1', line=dict(dash='dot', color='orange')))
                        ...
                        fig.add_trace(go.Scatter(x=forecast_dates_1, y=combined_forecast_1, mode='lines', name='Prediksi Masa Depan Cabang 1', line=dict(dash='dot', color='orange')))
