...
if st.session_state.page == "sales":
    ...
    # Show the dashboard for both branches or individual ones
    if "Bobby Aquatic 1" in branch_selection and "Bobby Aquatic 2" in branch_selection:
        ...
        show_dashboard(daily_profit_1, hw_forecast_future_1=hw_forecast_future_1, key_suffix='cabang1')
    elif "Bobby Aquatic 2" in branch_selection:
        show_dashboard(daily_profit_2, hw_forecast_future_2=hw_forecast_future_2, key_suffix='cabang2')
